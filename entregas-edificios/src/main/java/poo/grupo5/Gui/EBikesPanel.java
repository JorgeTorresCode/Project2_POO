 ...
 * @author yiyib
 */
public class EBikesPanel extends javax.swing.JPanel {
    ...
    public EBikesPanel(GuiController guiController, Control control){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cantidad de EBikes que desea crear:");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel3.setText("Peso Máximo que puede llevar:");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel4.setText("Peso mínimo que debe llevar:");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel5.setText("Cantidad de energía por 100 unidades de distancia:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (cantidad <= 0 || pesoMax <= 0 || energia <= 0 || pesoMin <= 0) {
            ...
            control.crearEBikes(cantidad, pesoMax, pesoMin, energia);
            JOptionPane.showMessageDialog(this,
            "Vehículos creados con éxito",
            "Éxito",
            JOptionPane.INFORMATION_MESSAGE);
            System.out.println(control.mostrarVehiculos());
            guiController.showMapaPanel();
