 ...
 * @author yiyib
 */
public class RoversPanel extends javax.swing.JPanel {
    ...
    public RoversPanel(GuiController guiController, Control control){
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cantidad de Rovers que desea crear:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (cantidad <= 0 || pesoMax <= 0 || energia <= 0 || pesoMin <= 0) {
            ...
            control.crearRovers(cantidad, pesoMax, pesoMin, energia);

            JOptionPane.showMessageDialog(this,
            "Vehículos creados con éxito",
            "Éxito",
            JOptionPane.INFORMATION_MESSAGE);
            guiController.showEBikesPanel();
        }
